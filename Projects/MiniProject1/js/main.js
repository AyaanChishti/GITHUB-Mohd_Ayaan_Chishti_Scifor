...
const createProd = (imgSrc, name, price, check) => {
  ...
  prodDesc.innerText =
    "A camera is a device that captures images or videos by focusing light through a lens onto a sensor or film. It's widely used in photography, filmmaking, and everyday life to record and share moments.";
